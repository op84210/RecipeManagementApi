...
{
    /// <inheritdoc />
    public partial class FixUtcTimestamps : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, 0.008m, new DateTime(2025, 7, 7, 7, 39, 36, 918, DateTimeKind.Utc).AddTicks(7133), "蛋白質含量12%以上的麵粉", true, new DateTime(2025, 7, 7, 7, 39, 36, 918, DateTimeKind.Utc).AddTicks(7476), 5000m, "高筋麵粉", 50000m, "統一麵粉公司", "公克" },
                    { 2, 0, 0.005m, new DateTime(2025, 7, 7, 7, 39, 36, 918, DateTimeKind.Utc).AddTicks(7814), "細白砂糖", true, new DateTime(2025, 7, 7, 7, 39, 36, 918, DateTimeKind.Utc).AddTicks(7815), 2000m, "砂糖", 20000m, "台糖公司", "公克" },
                    { 3, 0, 8.0m, new DateTime(2025, 7, 7, 7, 39, 36, 918, DateTimeKind.Utc).AddTicks(7818), "新鮮雞蛋", true, new DateTime(2025, 7, 7, 7, 39, 36, 918, DateTimeKind.Utc).AddTicks(7819), 50m, "雞蛋", 500m, "大成食品", "顆" },
                    { 4, 0, 0.02m, new DateTime(2025, 7, 7, 7, 39, 36, 918, DateTimeKind.Utc).AddTicks(7821), "法國進口無鹽奶油", true, new DateTime(2025, 7, 7, 7, 39, 36, 918, DateTimeKind.Utc).AddTicks(7821), 1000m, "無鹽奶油", 10000m, "法國乳品進口商", "公克" },
                    { 5, 0, 0.002m, new DateTime(2025, 7, 7, 7, 39, 36, 918, DateTimeKind.Utc).AddTicks(7824), "精製食鹽", true, new DateTime(2025, 7, 7, 7, 39, 36, 918, DateTimeKind.Utc).AddTicks(7824), 500m, "鹽", 5000m, "台鹽公司", "公克" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2025, 7, 7, 7, 39, 36, 919, DateTimeKind.Utc).AddTicks(7887), "經典白土司麵包，口感鬆軟香甜", 180, true, new DateTime(2025, 7, 7, 7, 39, 36, 919, DateTimeKind.Utc).AddTicks(8225), "白土司麵包", "BREAD-001", 45.0m, 2m, "條" },
                    { 2, 0, new DateTime(2025, 7, 7, 7, 39, 36, 919, DateTimeKind.Utc).AddTicks(8558), "香濃奶油小餐包，適合早餐", 150, true, new DateTime(2025, 7, 7, 7, 39, 36, 919, DateTimeKind.Utc).AddTicks(8559), "奶油小餐包", "BREAD-002", 60.0m, 12m, "個" }
                });
